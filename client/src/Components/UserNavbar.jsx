  ...
  return (
        ...
        <ul className="flex space-x-4">
            <Link to='/register'>
                <li className="font-medium hover:text-sky-600">
                    Profile <span><i className="fa-solid fa-right-to-bracket"></i></span>
                </li>
            </Link>
           <Link to='/logout'>
                <li className=" hover:text-sky-600 font-medium">
                    Logout <span><i className="fa-solid fa-user"></i></span>
                </li>
            </Link>
    ...
    {isOpen && 
     ...
     <ul className="flex flex-col space-y-2 ">
         <Link to='/register'>
             <li className="font-medium hover:text-sky-600">
                 Settings <span><i className="fa-solid fa-right-to-bracket"></i></span>
             </li>
         </Link>
        <Link to='/logout'>
             <li className=" hover:text-sky-600 font-medium">
